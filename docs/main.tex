...
El primer módulo implementado en el backend es el de gestión de usuarios,
    ...
    método antes de ejecutar determinadas peticiones. Conviene precisar que
    esta configuración es propia del entorno de desarrollo, en el que cliente
    y servidor se sirven en puertos distintos; en el despliegue con contenedores,
    donde ambos quedan tras un mismo punto de entrada y comparten origen,
    la comprobación de origen deja de intervenir.
